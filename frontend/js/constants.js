...
const h1_presale_mint1 = "Grab your precious PiCoin NFT now!!";
const h1_public_mint = "Public Minting Open!!";
const h1_public_mint1 = "Grab your precious PiCoin NFT now!!";
